...
abstract class RenderNode<P extends NodeParentData> extends RenderBox
  ...
  void performLayout() {
    ...
    RenderNode<NodeParentData>? child = firstChild;
    while (child != null) {
...
class RenderTree extends RenderBox with RenderObjectWithChildMixin<RenderNode> {
  ...
  RenderTree(CaTeXContext context) : _context = context;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    context.clipRectAndPaint(offset & size, Clip.hardEdge, Rect.zero, () {
